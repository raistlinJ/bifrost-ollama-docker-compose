...
ANCHOR_NAME="com.bifrost.ollama"
PORT="11434"
REMOVE_EXISTING=0
DRY_RUN=0
REMOTE_SUBNETS=""
PF_CONF="/etc/pf.conf"
MARKER_BEGIN="# BEGIN bifrost-ollama-docker-compose"
MARKER_END="# END bifrost-ollama-docker-compose"
...
write_anchor_file() {
  target_file="$1"
  {
    echo "# Managed by bifrost-ollama-docker-compose"
